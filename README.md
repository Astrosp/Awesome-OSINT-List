...
- [IPOK](https://ipok.io/) - Free, no-login IP reputation checker that aggregates multiple sources to flag proxy, VPN, Tor and datacenter vs residential, profiles /24 C-block neighbors, and shows each source's verdict side by side. CLI and browser extension.
